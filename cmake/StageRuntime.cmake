...
function(cfiq_configure_stage_runtime)
    ...
    cfiq_stage_alias("${CFIQ_STAGE_GFORTRAN_LIB}" "libgfortran.so.5")
    cfiq_stage_alias("${CFIQ_STAGE_GFORTRAN_LIB}" "libgfortran.so")
    ...
    cfiq_stage_copy_if_exists(stage_runtime "${CFIQ_STAGE_GFORTRAN_LIB}" "${CFIQ_STAGE_DIR}/lib")
