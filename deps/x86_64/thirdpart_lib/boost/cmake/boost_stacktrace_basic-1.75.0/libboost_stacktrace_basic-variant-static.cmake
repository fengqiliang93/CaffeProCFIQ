...
if(__boost_imploc)
  message(SEND_ERROR "Target Boost::stacktrace_basic already has an imported location '${__boost_imploc}', which is being overwritten with '${_BOOST_LIBDIR}/libboost_stacktrace_basic.a'")
endif()
