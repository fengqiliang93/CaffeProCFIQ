...
if(__boost_imploc)
  message(SEND_ERROR "Target Boost::math_c99 already has an imported location '${__boost_imploc}', which is being overwritten with '${_BOOST_LIBDIR}/libboost_math_c99.a'")
endif()
