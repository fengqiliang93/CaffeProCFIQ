...
inline void createFilterDesc(cudnnFilterDescriptor_t* desc,
  ...
  //    CUDNN_TENSOR_NCHW, n, c, h, w));
  cudnnSetFilter4dDescriptor_v4(*desc, dataType<Dtype>::type,
      CUDNN_TENSOR_NCHW, n, c, h, w);
#endif
}
...
inline void createPoolingDesc(cudnnPoolingDescriptor_t* pool_desc,
  ...
  cudnnSetPooling2dDescriptor(*pool_desc, *mode,
        CUDNN_PROPAGATE_NAN, h, w, pad_h, pad_w, stride_h, stride_w);
#else
  //CUDNN_CHECK(cudnnSetPooling2dDescriptor_v4(*pool_desc, *mode,
  //      CUDNN_PROPAGATE_NAN, h, w, pad_h, pad_w, stride_h, stride_w));
  cudnnSetPooling2dDescriptor_v4(*pool_desc, *mode,
        CUDNN_PROPAGATE_NAN, h, w, pad_h, pad_w, stride_h, stride_w);
#endif
}
...
inline void createActivationDescriptor(cudnnActivationDescriptor_t* activ_desc,
  ...
  cudnnSetActivationDescriptor(*activ_desc, mode,
                                           CUDNN_PROPAGATE_NAN, Dtype(0));
}
